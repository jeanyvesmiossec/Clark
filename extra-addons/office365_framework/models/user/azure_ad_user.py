...
class AzureAdUser(models.Model):
    ...
    def unlink(self):
        ...
        for user in self:
            ...
            user.record_link_ids.write({'active': False})
    ...
    def remove_webhook(self):
        ...
        for rec in self:
            ...
            rec.azure_ad_subscription_ids.unlink()
