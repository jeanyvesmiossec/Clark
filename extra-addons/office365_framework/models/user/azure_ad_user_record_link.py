...
class AzureAdUserRecordLink(models.Model):
    ...
    user_id = fields.Many2one(comodel_name='azure.ad.user', string='Azure AD User', ondelete='set null')
    ...
    def create(self, vals):
        ...
        if not res and 'data_id' in vals:
            res = self.with_context(active_test=False).search([('record', '=', vals['record']), ('data_id', '=', vals['data_id'])])
