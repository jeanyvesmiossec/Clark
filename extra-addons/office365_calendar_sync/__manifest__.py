...
{
    'name': 'Office 365 Calendar Sync',
    'version': '12.0.1.1',
    'author': 'Somko',
    'category': 'Productivity',
    'description': """Handles the synchronisation of Outlook and Odoo calendar Items.""",
    'summary': """Sync Outlook and Odoo calendar Items""",
    'website': 'https://www.somko.be',
    'images': ['static/description/cover.png',],
    'license': "OPL-1",
    'depends': ['base', 'office365_framework', 'calendar',],
    'data': [
        'views/res_users.xml',
